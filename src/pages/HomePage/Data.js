export const homeObjOne = {
    ...
    description:
        'Lassen Sie uns gemeinsam Ihre Erfolgsstory schreiben ',
    buttonLabel: '',
    imgStart: '',
...
export const homeObjFour = {
    ...
    description:
        'Regional – digital – ideal: Als zuverlässige Agentur für App- und Webentwicklung für Stuttgart, Aalen und Umgebung ist Peakconcepts Ihr starker Partner für die Positionierung Ihres Unternehmens auf dem digitalen Markt. Dabei profitieren Sie von attraktiven Vorteilen: ',
    buttonLabel: '',
    imgStart: 'start',
    img: require('../../Images/ino.jpg'),
    alt: 'Vault',
